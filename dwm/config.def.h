...
#include <X11/XF86keysym.h> /* multimedia/brightness/volume keysyms */
...
static const Key keys[] = {
	...
	{ MODKEY,                       XK_space,  spawn,          SHCMD("/home/safralph/.local/bin/appmenu") },
	{ MODKEY|Mod1Mask,              XK_space,  spawn,          SHCMD("/home/safralph/.local/bin/popmenu_toggle") },
	{ MODKEY,                       XK_k,      spawn,          SHCMD("/home/safralph/.local/bin/keybindsmenu") },
...
/* application bindings */
	{ MODKEY,			XK_m,          spawn,      {.v = (const char*[]){ "spotify-launcher", NULL } } },
	{ MODKEY,			XK_w,          spawn,      {.v = (const char*[]){ BROWSER, NULL } } },
	{ MODKEY|ShiftMask,	XK_f,          spawn,      {.v = (const char*[]){ "thunar", NULL } } },
...
/* script launch bindings */
	...
	{ MODKEY,				XK_v,      spawn,       SHCMD("/home/safralph/.local/bin/clipmenu") },
	{ MODKEY,				XK_g,      spawn,       SHCMD("/home/safralph/.local/bin/gamemode") },
	...
	{ MODKEY|ControlMask,	XK_w,      spawn,       {.v = (const char*[]){ "wallpapermenu", NULL } } },
	{ MODKEY,				XK_F1,     spawn,       SHCMD("screenshot") },
	{ MODKEY|ShiftMask,		XK_F1,     spawn,       SHCMD("screenshot color") },
	{ MODKEY|ControlMask,	XK_F1,     spawn,       SHCMD("screenshot full") },
	{ MODKEY|Mod1Mask,	XK_F1,     spawn,       SHCMD("screenshot window") },
	...
	{ MODKEY|ShiftMask,	XK_F3,     spawn,       {.v = (const char*[]){ "photomenu", NULL } } },
...
/* other bindings */
	...
	{ MODKEY|ShiftMask,		XK_F8,     spawn,       SHCMD("betterlockscreen -l & sleep 0.5 && systemctl suspend") },
	{ MODKEY,				XK_F8,     spawn,       SHCMD("betterlockscreen -l") },
...
/* multimedia keys (laptop fn keys / keyboard media buttons) */
	{ 0,					XF86XK_AudioRaiseVolume,   spawn, SHCMD("/home/safralph/.local/bin/volume-control +5%") },
	{ 0,					XF86XK_AudioLowerVolume,   spawn, SHCMD("/home/safralph/.local/bin/volume-control -5%") },
	{ 0,					XF86XK_AudioMute,          spawn, SHCMD("/home/safralph/.local/bin/volume-control toggle") },
	{ 0,					XF86XK_MonBrightnessUp,    spawn, SHCMD("/home/safralph/.local/bin/brightness-control 5%+") },
	{ 0,					XF86XK_MonBrightnessDown,  spawn, SHCMD("/home/safralph/.local/bin/brightness-control 5%-") },
	{ 0,					XF86XK_AudioPlay,          spawn, SHCMD("/home/safralph/.local/bin/media-control play-pause") },
	{ 0,					XF86XK_AudioPause,         spawn, SHCMD("/home/safralph/.local/bin/media-control play-pause") },
	{ 0,					XF86XK_AudioNext,          spawn, SHCMD("/home/safralph/.local/bin/media-control next") },
	{ 0,					XF86XK_AudioPrev,          spawn, SHCMD("/home/safralph/.local/bin/media-control previous") },
