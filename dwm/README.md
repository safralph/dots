## dwm - dynamic window manager - safralph's build
![my build](safralph_dwm.png)
...
## installation, setup:
```
git clone https://github.com/safralph/dots
cd dots/dwm
...
I use [dwmblocks](https://github.com/torrinfail/dwmblocks) for my statusbar ([bar scripts](https://github.com/safralph/dots/tree/master/scripts)), included in ```~/.xprofile``` with ```exec dwmblocks```.
